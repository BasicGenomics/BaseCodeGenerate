...
rule all:
    input: "geneannotations.positive.gff3", "reference.fa", "reference.fa.fai"., "genomeref.3n.GA.1.ht2".
...
rule split_gff_file:
    ...
    output: "geneannotations.positive.gff3"., "geneannotations.negative.gff3".
    threads: 1
    conda: "envs/full.yaml"
...
rule hisat3n_build:
    input: ss = "splicesites.ss"., exon = "genome.exons"., reference = "reference.fa".
